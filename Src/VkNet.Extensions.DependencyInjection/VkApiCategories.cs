...
public class VkApiCategories : IVkApiCategories
{
    ...
    public IMessagesCategory Messages 
        => _provider.GetRequiredService<IMessagesCategory>(); 
    public IGroupsCategory Groups => 
        _provider.GetRequiredService<IGroupsCategory>(); 
    ...
    public IExecuteCategory Execute 
        => _provider.GetRequiredService<IExecuteCategory>(); 
